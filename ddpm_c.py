...
class DiffusionModel(nn.Module):
    ...
    def forward(self, x, t):
        ...
        ##x = self.diffusion.sample_image(x_in, self.model)
        print(t)
        print("-----------------------tttttttttt")
        ##x = self.sampling(x, t)
        ...
        ##imgs = torch.nn.functional.interpolate(x[0], (224, 224), mode='bicubic', antialias=True)
        imgs = torch.nn.functional.interpolate(x, (512, 512), mode='bicubic', antialias=True)   
