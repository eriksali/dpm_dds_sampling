...
if __name__ == "__main__":
    latex_table_certified_accuracy(
        "analysis/latex/vary_noise_cifar10", 0.00, 1.5, 0.25, [
            Line(ApproximateAccuracy("results/cifar10/sigma_0.00"), "$\sigma = 0.00$"),
            Line(ApproximateAccuracy("results/cifar10/sigma_0.12"), "$\sigma = 0.12$"),
            Line(ApproximateAccuracy("results/cifar10/sigma_0.25"), "$\sigma = 0.25$"),
            Line(ApproximateAccuracy("results/cifar10/sigma_0.50"), "$\sigma = 0.50$"),
            Line(ApproximateAccuracy("results/cifar10/sigma_1.00"), "$\sigma = 1.00$"),
        ])
    markdown_table_certified_accuracy(
        "analysis/markdown/vary_noise_cifar10", 0.00, 1.5, 0.25, [
            Line(ApproximateAccuracy("results/cifar10/sigma_0.00"), "&sigma; = 0.00"),
            Line(ApproximateAccuracy("results/cifar10/sigma_0.12"), "&sigma; = 0.12"),
            Line(ApproximateAccuracy("results/cifar10/sigma_0.25"), "&sigma; = 0.25"),
            Line(ApproximateAccuracy("results/cifar10/sigma_0.50"), "&sigma; = 0.50"),
    ...
    plot_certified_accuracy(
        "analysis/plots/vary_noise_cifar10", "CIFAR-10, vary $\sigma$", 0.8 , [
            ##Line(ApproximateAccuracy("results/cifar10/sigma_0.00"), "$\sigma = 0.00$"),
            Line(ApproximateAccuracy("results/cifar10/sigma_0.12"), "$\sigma = 0.12$"),
            Line(ApproximateAccuracy("results/cifar10/sigma_0.25"), "$\sigma = 0.25$"),
            Line(ApproximateAccuracy("results/cifar10/sigma_0.50"), "$\sigma = 0.50$"),
